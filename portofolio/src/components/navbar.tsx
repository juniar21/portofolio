    ...
    <header>
      <div className="flex items-center justify-between w-full max-w-[1100px] mx-auto h-[100px] px-4 md:flex-nowrap text-black font-bold text-sm">
        ...
        >
          <Link
            href={"#about"}
            className="block py-2 md:py-0 hover:border-b-2 max-sm:text-white text-black"
          >
            About Me
          </Link>
          <Link
        ...
        <div className="hidden md:block">
          <button className="flex p-2 outline text-white bg-black rounded-md">
            Resume <MdOutlineFileDownload className="h-[20px] w-[40px]" />
          </button>
        </div>
      </div>
    </header>
